...
/// <summary>
/// SQLite implementation of telemetry persistence using Entity Framework Core.
/// </summary>
/// <remarks>
/// <para>
/// This implementation provides <strong>write-only persistence</strong> for Aspire Dashboard telemetry data.
/// Logs, traces, and metrics are written to SQLite for long-term storage and compliance purposes,
...
/// the Dashboard's SQLite directly.
/// </description>
/// </item>
/// </list>
/// <para>
...
/// </para>
/// <list type="bullet">
/// <item><description>✅ Persistent storage of logs, traces, spans, and metrics to SQLite</description></item>
...
/// </para>
/// </remarks>
public sealed class SqliteTelemetryPersistence : ITelemetryPersistence, IAsyncDisposable
{
    private readonly ILogger<SqliteTelemetryPersistence> _logger;
    private readonly SqliteTelemetryOptions _options;
    private readonly IDbContextFactory<SqliteTelemetryDbContext> _contextFactory;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SqliteTelemetryPersistence"/> class.
    /// </summary>
    public SqliteTelemetryPersistence(
        IOptions<SqliteTelemetryOptions> options,
        IDbContextFactory<SqliteTelemetryDbContext> contextFactory,
        ILogger<SqliteTelemetryPersistence> logger,
        IOptions<Configuration.DashboardOptions> dashboardOptions)
    {
        ...
        _logger.LogInformation("SqliteTelemetryPersistence initialized (ConnectionString configured: {HasConnectionString})",
    ...
    public async Task AddLogAsync(OtlpLogEntry log, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error adding log to SQLite");
            throw;
        }
    }
    ...
    public async Task AddLogsAsync(IEnumerable<OtlpLogEntry> logs, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error adding logs to SQLite");
            throw;
        }
    }
    ...
    public async Task<PagedResult<OtlpLogEntry>> GetLogsAsync(GetLogsContext context, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error retrieving logs from SQLite");
            return PagedResult<OtlpLogEntry>.Empty;
        }
    }
    ...
    public async Task<OtlpLogEntry?> GetLogAsync(long logId, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error retrieving log {LogId} from SQLite", logId);
            return null;
        }
    }
    ...
    public async Task AddTraceAsync(OtlpTrace trace, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error adding trace {TraceId} to SQLite", trace.TraceId);
            throw;
        }
    }
    ...
    public async Task<GetTracesResponse> GetTracesAsync(GetTracesRequest request, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            await using (context.ConfigureAwait(false))
            {
                ...
                var maxDuration = traces.Count != 0 ? traces.Max(t => t.Duration) : TimeSpan.Zero;
        ...
        {
            _logger.LogError(ex, "Error retrieving traces from SQLite");
            return new GetTracesResponse
            {
    ...
    public async Task<OtlpTrace?> GetTraceAsync(string traceId, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            await using (context.ConfigureAwait(false))
            {
                ...
                if (entity is not null)
                {
                    ...
                    return MapEntityToTrace(entity);
                }
        ...
        {
            _logger.LogError(ex, "Error retrieving trace {TraceId} from SQLite", traceId);
            return null;
        }
    }
    ...
    public async Task<OtlpSpan?> GetSpanAsync(string traceId, string spanId, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error retrieving span {SpanId} from trace {TraceId} in SQLite", spanId, traceId);
            return null;
        }
    }
    ...
    public async Task AddMetricsAsync(OtlpResource resource, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error adding metrics for resource {ResourceName} to SQLite", resource.ResourceName);
            throw;
        }
    }
    ...
    public async Task ClearLogsAsync(ResourceKey? resourceKey = null, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error clearing logs from SQLite");
            throw;
        }
    }
    ...
    public async Task ClearTracesAsync(ResourceKey? resourceKey = null, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error clearing traces from SQLite");
            throw;
        }
    }
...
/// <summary>
/// Configuration options for SQLite telemetry persistence.
/// </summary>
