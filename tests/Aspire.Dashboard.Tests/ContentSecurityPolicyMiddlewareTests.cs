...
public class ContentSecurityPolicyMiddlewareTests
{
    ...
    private static ContentSecurityPolicyMiddleware CreateMiddleware(string environmentName) =>
        new ContentSecurityPolicyMiddleware(c => Task.CompletedTask, new TestHostEnvironment { EnvironmentName = environmentName });
